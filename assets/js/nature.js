...
function generateGalleryItemsnature(totalImagesnature) {
    const container = document.getElementById('nature-container');
    
    for (let i = 1; i < totalImagesnature; i++) {
